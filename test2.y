...
%type <statm> Statements Statement ElseStatement
%type <expr> RelationExpr RelationExpr0 RelationAndExpr BoolExpr Term Comp MultiplicativeExpression Expression Expressions
%type <expr> Vars Var Declaration Declartions Identifiers 
...
Program: Function Program {printf("Program --> Function Program\n");} | %empty {
	...
	if (variables.find(tempPname) == functions.end()) {
		char errorTemp [130];
