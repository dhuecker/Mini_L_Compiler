...
Declaration: Identifiers COLON ARRAY L_SQUARE_BRACKET NUMBER R_SQUARE_BRACKET OF INTEGER  {printf("Declaration --> Identifiers COLON ARRAY L_SQUARE_BRACKET NUMBER %d R_SQUARE_BRACKET OF INTEGER  \n", $5);} | Identifiers COLON INTEGER  {printf("Declaration --> Identifiers COLON INTEGER  \n");}
;
